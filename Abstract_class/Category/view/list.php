...
$data = new Category();
$categories = $data->showData("Category");
...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <table class="table table-bordered">
            ...
            <?php foreach ($categories as $category) : ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="Class/update.php?id=<?php echo $category['id_category']?>">Update</a>
                        <a href="Class/delete.php?id=<?php echo $category['id_category']?>">Delete</a>
                    </td>
                </tr>
        ...
        <form method="post">
            <a href="Class/addNew.php">Add New Category</a>
        </form>
        <hr>
    </div>
